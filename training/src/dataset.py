...
def filter_valid_data(label_file):
    ...
    for annotation in annotations:
        ...
        image_dict[annotation['path']] = [
            [
                mark['startX'] * annotation['w'],
                mark['startY'] * annotation['h'],
                mark['endX'] * annotation['w'],
                mark['endY'] * annotation['h'],
                label_id[mark['tag']]
            ] 
            for mark in annotation['marks']    
        ]
        image_files.append(annotation['path'])
...
def data_to_mindrecord_byte_image(image_dir, mindrecord_dir, prefix, file_num, label_path):
    """Create MindRecord file by image_dir and anno_path."""
    mindrecord_path = os.path.join(mindrecord_dir, prefix)
    writer = FileWriter(mindrecord_path, file_num)
    image_files, image_anno_dict = filter_valid_data(label_path)
    ...
    # print([ x for x in Path(image_dir).iterdir()])
